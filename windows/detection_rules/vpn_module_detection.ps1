# =============================================================================
# Script:   vpn_module_detect.ps1
# Purpose:  Detects whether the Cisco Secure Client AnyConnect VPN module is
#           installed on the endpoint and meets the minimum required version.
#           Used by Microsoft Intune as the custom detection rule script for
#           the Cisco Secure Client VPN Win32 application deployment.
#
# Overview:
#   This script queries the installed packages on the endpoint for the Cisco
#   Secure Client AnyConnect VPN module and evaluates the installed version
...
#   Rules step of the Cisco Secure Client VPN Win32 app deployment in Intune.
#
# Usage:
...
#   ./PsExec.exe -i -s powershell.exe -ExecutionPolicy Bypass -File "vpn_module_detect.ps1"
#
# Configuration:
#   - Update the minimum version string "5.1.15.287" to match the minimum
#     acceptable version of the AnyConnect VPN module for your environment.
#     This value should match the version of the MSI included in the
#     .intunewin package, or a lower version if older installations are
...
# Retrieves all installed packages matching the Cisco Secure Client AnyConnect VPN module
$app = @(Get-Package -Name "Cisco Secure Client - AnyConnect VPN")
